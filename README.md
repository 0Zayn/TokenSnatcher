Small thing that gets a discord token from a running discord client via a request they send from their electron app to their API which includes the users token.
